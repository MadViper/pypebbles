...
@pytest.mark.vcr
def test_should_post(echo: HttpTransport[Echo], a_json: JsonDict) -> None:
    (
        HttpRequest()
        .with_endpoint("post")
...
@pytest.mark.vcr
def test_should_submit(echo: HttpTransport[Echo], a_json: JsonDict) -> None:
    (
        HttpRequest()
        .with_endpoint("post")
...
@pytest.mark.vcr
def test_should_get(echo: HttpTransport[Echo]) -> None:
    (
        HttpRequest()
        .with_endpoint("get")
        .using(echo)
...
@pytest.mark.vcr
def test_should_get_with_params(echo: HttpTransport[Echo]) -> None:
    (
        HttpRequest()
        .with_endpoint("get")
...
@pytest.mark.vcr
def test_should_patch(echo: HttpTransport[Echo], a_json: JsonDict) -> None:
    (
        HttpRequest()
        .with_endpoint("patch")
        .with_json(value=a_json)
...
@pytest.mark.vcr
def test_should_delete(echo: HttpTransport[Echo]) -> None:
    (
        HttpRequest()
...
@pytest.mark.vcr
def test_should_put(echo: HttpTransport[Echo], a_json: JsonDict) -> None:
    (
        HttpRequest()
        .with_endpoint("put")
        .with_json(value=a_json)
